                    ...
                    <div class="row">
                        @foreach ($featured_categories as $key => $category)
                            <div class="col-md-3 col-sm-4 col-6 mb-3">
                                <div class="position-relative text-center has-transition hov-scale-img hov-animate-outline border-right border-top border-bottom @if($key == 0) border-left @endif">
