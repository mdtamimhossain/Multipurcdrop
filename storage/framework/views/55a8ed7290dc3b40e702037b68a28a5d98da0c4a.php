<div class="bg-white border">
    ...
    <div class="px-4">
        <div class="aiz-carousel gutters-5 half-outside-arrow" data-items="5" data-xl-items="3"
            ...
            <?php $__currentLoopData = filter_products(\App\Models\Product::where('category_id', $detailedProduct->category_id)
                        ->where('id', '!=', $detailedProduct->id))->limit(10)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $related_product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
</div><?php /**PATH C:\Users\Tamim\Documents\projects\multipurcdrop\resources\views/frontend/product_details/related_products.blade.php ENDPATH**/ ?>