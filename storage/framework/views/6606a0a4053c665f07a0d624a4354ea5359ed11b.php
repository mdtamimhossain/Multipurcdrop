...
<div class="position-relative top-banner removable-session z-1035 d-none" data-key="top-banner" data-value="removed">
    <a href="<?php echo e(get_setting('topbar_banner_link')); ?>" class="d-block text-reset">
        <img src="<?php echo e(uploaded_asset(get_setting('topbar_banner'))); ?>" class="d-none d-xl-block img-fit"> <!-- For Large device -->
        <img src="<?php echo e(get_setting('topbar_banner_medium') != null ? uploaded_asset(get_setting('topbar_banner_medium')) : uploaded_asset(get_setting('topbar_banner'))); ?>" class="d-none d-md-block d-xl-none img-fit"> <!-- For Medium device -->
        <img src="<?php echo e(get_setting('topbar_banner_small') != null ? uploaded_asset(get_setting('topbar_banner_small')) : uploaded_asset(get_setting('topbar_banner'))); ?>" class="d-md-none img-fit"> <!-- For Small device -->
    </a>
                ...
                <ul class="list-inline d-flex justify-content-between justify-content-lg-start mb-0">
                    ...
                    <li class="list-inline-item dropdown mr-4" id="lang-change">
                        ...
                        <a href="javascript:void(0)" class="dropdown-toggle text-secondary fs-12 py-2" data-toggle="dropdown" data-display="static">
                            <span class=""><?php echo e(\App\Models\Language::where('code', $locale)->first()->name); ?></span>
                        </a>
                    ...
                    <li class="list-inline-item dropdown ml-auto ml-lg-0 mr-0" id="currency-change">
                        ...
                        ?>
                        <a href="javascript:void(0)" class="dropdown-toggle text-secondary fs-12 py-2" data-toggle="dropdown" data-display="static">
                            <?php echo e(\App\Models\Currency::where('code', $currency_code)->first()->name); ?>
                ...
                <ul class="list-inline mb-0 h-100 d-flex justify-content-end align-items-center">
                    <?php if(get_setting('vendor_system_activation') == 1): ?>
                        ...
                        <li class="list-inline-item mr-0 pl-0 py-2">
                            <a href="<?php echo e(route('shops.create')); ?>" class="text-secondary fs-12 pr-3 d-inline-block border-width-2 border-right"><?php echo e(translate('Become a Seller !')); ?></a>
                        </li>
                        <!-- Seller Login -->
                        <li class="list-inline-item mr-0 pl-0 py-2">
                            <a href="<?php echo e(route('seller.login')); ?>" class="text-secondary fs-12 pl-3 d-inline-block"><?php echo e(translate('Login to Seller')); ?></a>
                        </li>
                    <?php endif; ?>
                    <?php if(get_setting('helpline_number')): ?>
                        <!-- Helpline -->
                        <li class="list-inline-item ml-3 pl-3 mr-0 pr-0">
                            <a href="tel:<?php echo e(get_setting('helpline_number')); ?>" class="text-secondary fs-12 d-inline-block py-2">
                                <span><?php echo e(translate('Helpline')); ?></span>  
        ...
        <div class="container">
            <div class="d-flex align-items-center">
                        ...
                        <form action="<?php echo e(route('search')); ?>" method="GET" class="stop-propagation">
                            <div class="d-flex position-relative align-items-center">
                                ...
                                <div class="search-input-box">
                                    <input type="text" class="border border-soft-light form-control fs-14 hov-animate-outline" id="search" name="keyword" <?php if(isset($query)): ?>
                            ...
                            <span class="">
                                <span class="position-relative d-inline-block">
                                    ...
                                    <?php if(Auth::check() && count(Auth::user()->unreadNotifications) > 0): ?>
                                        <span class="badge badge-primary badge-inline badge-pill absolute-top-right--10px"><?php echo e(count(Auth::user()->unreadNotifications)); ?></span>
                                    <?php endif; ?>
                            </span>
                        </a>
                        ...
                        <?php if(auth()->guard()->check()): ?>
                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg py-0 rounded-0">
                                        ...
                                        <?php $__empty_1 = true; $__currentLoopData = Auth::user()->unreadNotifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <li class="list-group-item">
                                                <?php if($notification->type == 'App\Notifications\OrderNotification'): ?>
                                                    ...
                                                    <a href="<?php echo e(route('purchase_history.details', encrypt($notification->data['order_id']))); ?>" class="text-secondary fs-12">
                                                        <span class="ml-2">
                                                    ...
                                                    <?php elseif(Auth::user()->user_type == 'seller'): ?>
                                                        <a href="<?php echo e(route('seller.orders.show', encrypt($notification->data['order_id']))); ?>" class="text-secondary fs-12">
                                                            <span class="ml-2">
                                                                <?php echo e(translate('Order code: ')); ?> <?php echo e($notification->data['order_code']); ?> <?php echo e(translate('has been '. ucfirst(str_replace('_', ' ', $notification->data['status'])))); ?>
                                ...
                                <div class="text-center border-top">
                                    <a href="<?php echo e(route('all-notifications')); ?>" class="text-secondary fs-12 d-block py-2">
                ...
                <div class="ml-auto mr-0">
                    <?php if(auth()->guard()->check()): ?>
                        <span class="d-none d-xl-flex align-items-center nav-user-info py-20px <?php if(isAdmin()): ?> ml-5 <?php endif; ?>" id="nav-user-info">
                            <!-- Image -->
                        ...
                        <ul class="list-unstyled no-scrollbar mb-0 text-left">
                            <?php if(isAdmin()): ?>
                                <li class="user-top-nav-element border border-top-0" data-id="1">
                                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="text-truncate text-dark px-4 fs-14 d-flex align-items-center hov-column-gap-1">
                            ...
                            <?php if(isCustomer()): ?>
                                <li class="user-top-nav-element border border-top-0" data-id="1">
                                    <a href="<?php echo e(route('purchase_history.index')); ?>" class="text-truncate text-dark px-4 fs-14 d-flex align-items-center hov-column-gap-1">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                                        ...
                                        <span class="user-top-menu-name has-transition ml-3"><?php echo e(translate('Purchase History')); ?></span>
                                    </a>
                                </li>
                                <li class="user-top-nav-element border border-top-0" data-id="1">
                                    <a href="<?php echo e(route('digital_purchase_history.index')); ?>" class="text-truncate text-dark px-4 fs-14 d-flex align-items-center hov-column-gap-1">
                                ...
                                <li class="user-top-nav-element border border-top-0" data-id="1">
                                    <a href="<?php echo e(route('conversations.index')); ?>" class="text-truncate text-dark px-4 fs-14 d-flex align-items-center hov-column-gap-1">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                                ...
                                <li class="user-top-nav-element border border-top-0" data-id="1">
                                    <a href="<?php echo e(route('wallet.index')); ?>" class="text-truncate text-dark px-4 fs-14 d-flex align-items-center hov-column-gap-1">
                                ...
                                <?php endif; ?>
                                <li class="user-top-nav-element border border-top-0" data-id="1">
                                    <a href="<?php echo e(route('support_ticket.index')); ?>" class="text-truncate text-dark px-4 fs-14 d-flex align-items-center hov-column-gap-1">
                ...
                <div class="d-none d-xl-block all-category has-transition bg-black-10" id="category-menu-bar">
                    <div class="px-3 h-100" style="padding-top: 12px;padding-bottom: 12px; width:270px; cursor: pointer;">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                <span class="fw-700 fs-16 text-white mr-3"><?php echo e(translate('Categories')); ?></span>
                                <a href="<?php echo e(route('categories.all')); ?>" class="text-reset">
                                    <span class="d-none d-lg-inline-block text-white hov-opacity-80">(<?php echo e(translate('See All')); ?>)</span>
                                </a>
                            </div>
...
<?php /**PATH C:\Users\Tamim\Documents\projects\multipurcdrop\resources\views/frontend/inc/nav.blade.php ENDPATH**/ ?>