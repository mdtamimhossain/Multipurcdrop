...
<div class="aiz-card-box h-auto bg-white py-3 hov-scale-img">
    <div class="position-relative h-140px h-md-200px img-fit overflow-hidden">
        ...
        <a href="<?php echo e($product_url); ?>" class="d-block h-100">
            <img class="lazyload mx-auto img-fit has-transition" src="<?php echo e(static_asset('assets/img/placeholder.jpg')); ?>"
                data-src="<?php echo e(uploaded_asset($product->thumbnail_img)); ?>" alt="<?php echo e($product->getTranslation('name')); ?>"
...
<?php /**PATH C:\Users\Tamim\Documents\projects\multipurcdrop\resources\views/frontend/partials/product_box_1.blade.php ENDPATH**/ ?>