<?php if($detailedProduct->added_by == 'seller' && $detailedProduct->user->shop != null): ?>
    <div class="border mb-4" style="background: #fcfcfd;">
        <div class="position-relative p-3 p-sm-4 text-left">
            <div class="opacity-60 fs-14 mb-3"><?php echo e(translate('Seller')); ?></div>
            <div class="mt-1">
                <!-- Shop Logo -->
                <?php if($detailedProduct->added_by == 'seller' && get_setting('vendor_system_activation') == 1): ?>
                <a href="<?php echo e(route('shop.visit', $detailedProduct->user->shop->slug)); ?>" class="avatar avatar-md mr-2 overflow-hidden border float-left float-lg-none float-xl-left">
                    <img class="lazyload"
                        src="<?php echo e(static_asset('assets/img/placeholder.jpg')); ?>"
                        data-src="<?php echo e(uploaded_asset($detailedProduct->user->shop->logo)); ?>"
            ...
            <div class="mt-3">
                ...
                <div class="opacity-60 fs-12">
                    (<?php echo e($detailedProduct->user->shop->num_of_reviews); ?>

                    <?php echo e(translate('customer reviews')); ?>)
                </div>
            </div>
            <!-- Social Links -->
            <?php if($detailedProduct->user->shop->facebook || $detailedProduct->user->shop->google || $detailedProduct->user->shop->twitter || $detailedProduct->user->shop->youtube): ?>
                <div class="mt-3">
                    <ul class="social list-inline mb-0">
                        <?php if($detailedProduct->user->shop->facebook): ?>
                        ...
                        <?php endif; ?>
                        <?php if($detailedProduct->user->shop->instagram): ?>
                        <li class="list-inline-item mr-2 mb-2">
                            <a href="<?php echo e($detailedProduct->user->shop->instagram); ?>" class="instagram"
                                target="_blank">
                                <i class="lab la-instagram opacity-60"></i>
                            </a>
                        </li>
                        <?php endif; ?>
                        <?php if($detailedProduct->user->shop->google): ?>
                        <li class="list-inline-item mr-2 mb-2">
                        ...
                        <?php endif; ?>
                        <?php if($detailedProduct->user->shop->twitter): ?>
                        <li class="list-inline-item mr-2 mb-2">
                        ...
                        <?php endif; ?>
                        <?php if($detailedProduct->user->shop->youtube): ?>
            ...
            <div class="mt-3">
                <a href="<?php echo e(route('shop.visit', $detailedProduct->user->shop->slug)); ?>"
                    class="btn btn-block btn-slide-warning fs-14 fw-700 rounded-0"><?php echo e(translate('Visit Store')); ?></a>
            </div>
        </div>
    </div>
<?php endif; ?><?php /**PATH C:\Users\Tamim\Documents\projects\multipurcdrop\resources\views/frontend/product_details/seller_info.blade.php ENDPATH**/ ?>