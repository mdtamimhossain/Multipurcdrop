                                        ...
                                        <ul class="p-3 mb-0 list-unstyled">
                                            <?php if(!isset($category_id)): ?>
                                                <?php $__currentLoopData = \App\Models\Category::where('level', 0)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <li class="mb-3 text-dark">
                                                        <a class="text-reset fs-14 hov-text-primary" href="<?php echo e(route('products.category', $category->slug)); ?>"><?php echo e($category->getTranslation('name')); ?></a>
                                                    </li>
                                            ...
                                            <?php else: ?>
                                                ...
                                                <?php if(\App\Models\Category::find($category_id)->parent_id != 0): ?>
                                                    <li class="mb-3">
                                                        <a class="text-reset fs-14 fw-600 hov-text-primary" href="<?php echo e(route('products.category', \App\Models\Category::find(\App\Models\Category::find($category_id)->parent_id)->slug)); ?>">
                                                            <i class="las la-angle-left"></i>
                                                ...
                                                <?php endif; ?>
                                                <li class="mb-3">
                                                    <a class="text-reset fs-14 fw-600 hov-text-primary" href="<?php echo e(route('products.category', \App\Models\Category::find($category_id)->slug)); ?>">
                                                        <i class="las la-angle-left"></i>
                                                ...
                                                <?php $__currentLoopData = \App\Utility\CategoryUtility::get_immediate_children_ids($category_id); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $id): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <li class="ml-4 mb-3">
                                                        <a class="text-reset fs-14 hov-text-primary" href="<?php echo e(route('products.category', \App\Models\Category::find($id)->slug)); ?>"><?php echo e(\App\Models\Category::find($id)->getTranslation('name')); ?></a>
                                                    </li>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <?php endif; ?>
                                        </ul>
                                    ...
                                    <div class="p-3 mr-3">
                                        <div class="aiz-range-slider">
                                            <div
                                                ...
                                                data-range-value-min="<?php if(\App\Models\Product::where('published', 1)->count() < 1): ?> 0 <?php else: ?> <?php echo e(\App\Models\Product::where('published', 1)->min('unit_price')); ?> <?php endif; ?>"
                                                data-range-value-max="<?php if(\App\Models\Product::where('published', 1)->count() < 1): ?> 0 <?php else: ?> <?php echo e(\App\Models\Product::where('published', 1)->max('unit_price')); ?> <?php endif; ?>"
                                            ></div>
                                ...
                                <div class="col-6 col-lg-auto mb-3 w-lg-200px mr-xl-4 mr-lg-3">
                                    <?php if(Route::currentRouteName() != 'products.brand'): ?>
                                        <select class="form-control form-control-sm aiz-selectpicker rounded-0" data-live-search="true" name="brand" onchange="filter()">
                                            <option value=""><?php echo e(translate('Brands')); ?></option>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Tamim\Documents\projects\multipurcdrop\resources\views/frontend/product_listing.blade.php ENDPATH**/ ?>