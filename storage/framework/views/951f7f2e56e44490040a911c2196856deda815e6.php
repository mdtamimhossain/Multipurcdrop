...
<a href="javascript:void(0)" class="d-flex align-items-center text-dark px-3 h-100" data-toggle="dropdown" data-display="static" title="<?php echo e(translate('Cart')); ?>">
    ...
    <span class="d-none d-xl-block ml-2 fs-14 fw-700 text-white"><?php echo e(single_price($total)); ?></span>
    <span class="nav-box-text d-none d-xl-block ml-2 text-white fs-12">
        (<span class="cart-count"><?php echo e((isset($cart) && count($cart) > 0) ? count($cart) : 0); ?></span> <?php echo e(translate('Items')); ?>)
    </span>
</a>
        ...
        <div class="py-3 text-center border-top mx-4" style="border-color: #e5e5e5 !important;">
            <div class="row gutters-10 justify-content-center">
                <div class="col-sm-6 mb-2">
                    <a href="<?php echo e(route('cart')); ?>" class="btn btn-warning btn-sm btn-block rounded-4 text-white">
                ...
                <?php if(Auth::check()): ?>
                <div class="col-sm-6">
                    <a href="<?php echo e(route('checkout.shipping_info')); ?>" class="btn btn-primary btn-sm btn-block rounded-4">
...
<?php /**PATH C:\Users\Tamim\Documents\projects\multipurcdrop\resources\views/frontend/partials/cart.blade.php ENDPATH**/ ?>