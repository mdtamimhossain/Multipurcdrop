        ...
        <table class="table" style="margin-top: 2rem!important;">
            <tfoot>
                ...
                <tr class="cart-subtotal">
                    ...
                    <td class="text-right pr-0 fs-14 pt-0 pb-2 fw-600 text-primary border-top-0">
                        <span class="fw-600"><?php echo e(single_price($earnings-$subtotal)); ?></span>
                    </td>
                </tr>
                <!-- Tax -->
...
<?php /**PATH C:\Users\Tamim\Documents\projects\multipurcdrop\resources\views/frontend/partials/cart_summary.blade.php ENDPATH**/ ?>