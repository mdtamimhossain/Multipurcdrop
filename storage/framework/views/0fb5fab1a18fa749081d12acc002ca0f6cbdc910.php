<div class="bg-white border mb-4">
    ...
    <div class="px-3 px-sm-4 pb-4">
        <ul class="list-group list-group-flush">
            <?php $__currentLoopData = filter_products(\App\Models\Product::where('user_id', $detailedProduct->user_id)
                        ->orderBy('num_of_sale', 'desc'))->limit(6)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $top_product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH C:\Users\User\Documents\projects\Multipurcdrop\resources\views/frontend/product_details/top_selling_products.blade.php ENDPATH**/ ?>