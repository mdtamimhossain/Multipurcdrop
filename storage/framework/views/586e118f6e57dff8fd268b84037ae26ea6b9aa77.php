    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body pt-3 pb-5 px-xl-5">
                <p class="text-danger mt-3"><i><strong><?php echo e(translate('Note: ')); ?>&nbsp;<?php echo e(translate("Don't Click to any button or don't do any action during account Deletion, it may takes some times.")); ?></strong></i></p>
                <p class="fs-14 fw-700" style="color: #8d8d8d;"><?php echo e(translate('Deleting Account Means:')); ?></p>
                <div class="row bg-soft-warning py-2 mb-2 ml-0 mr-0 border-left border-width-2 border-danger">
                    <div class="col-1">
                        <img src="<?php echo e(static_asset('assets/img/warning.png')); ?>" class="h-20px">
                    </div>
                    <div class="col">
...
<?php /**PATH C:\Users\Tamim\Documents\projects\multipurcdrop\resources\views/frontend/partials/account_delete_modal.blade.php ENDPATH**/ ?>